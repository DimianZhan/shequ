      ...
      <div class="container">
        <div class="row footer-top">
          ...
          <div class="col-sm-5 col-lg-5">
              ...
              <p class="padding-top-xsm">我们是高品质的无人机开发者社区，致力于为 PX4/ArduPilot 开发者提供一个分享创造、结识伙伴、协同互助的平台。</p>
              <p><a href="http://www.miitbeian.gov.cn">苏ICP备17001975号-5</a></p>
              <div class="text-md " >
                  <a class="popover-with-html" data-content="反馈问题" target="_blank" style="padding-right:8px" href="mailto:stone@dimianzhan.com"><i class="fa fa-envelope" aria-hidden="true"></i></a>
                  <a class="popover-with-html" data-content="查看源代码" target="_blank" style="padding-right:8px" href="https://github.com/DimianZhan/shequ"><i class="fa fa-github-alt" aria-hidden="true"></i></a>
                  ...
                  <a class="popover-with-html" data-content="扫码关注微信订阅号：「地面情报站」" target="_blank" style="padding-right:8px" href="http://shequ.dimianzhan.com/uploads/images/201811/dimianzhan.gif"><i class="fa fa-weixin" aria-hidden="true"></i></a>
              ...
              <!-- <span style="font-size:0.9em">
                  Powered by <a href="https://github.com/DimianZhan/shequ" target="_blank" style="color:inherit">PHPHub</a>
              </span><br> -->
              <span style="font-size:0.9em">
